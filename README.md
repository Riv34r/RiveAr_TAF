...
| `tests/ui/test_cart.py` | UI-CART-01..05 | A guest's cart - one line per product, kept across a reload, carried over once on login, refused lines dropped with a warning, back to checkout after logging in; a reload of checkout (BUG-006) |
